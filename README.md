...
- **Linguagens:** Java, C#, C++, Python, JavaScript, TypeScript, SQL, HTML/CSS  
- **Backend:** Java (Spring Boot), .NET Core, REST APIs, PostgreSQL, MongoDB, Redis, RabbitMQ, AWS SQS  
- **Frontend / Web:** Thymeleaf, JavaScript, HTML5, CSS3  
- **Segurança / Windows:** WinAPI, Rust, C++, OpenSSL, anti-debugging, verificação de assinatura binária  
